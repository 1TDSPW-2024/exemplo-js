...
//recuperando o botao submit com querryselector

const btnElemento = document.querySelector("button[type='submit']");

btnElemento.addEventListener("click",()=>{


    //salvar dados do formulario funcao
    ...
    if(btnElemento.innerText === "Enviar"){
        btnElemento.innerHTML = "Enviado";
    }else{
        btnElemento.innerText = "Enviar";
    }   
}
);
