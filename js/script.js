...
// Resposta: str = string, float = numero real, int = numero inteiro, bool = booleano
...
let arr0 = ''
let arr1  = ["manga", "maracuja", "morango"];
let arr2 = ["pera", "maca", "uva"];
let arrConcatenado = arr0.concat([arr1] + [arr2]);
